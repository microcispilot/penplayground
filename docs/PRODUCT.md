...
| **Standard** | $29/mo ($290/yr) | No ads. The expert answers questions live, and writes the recap. Any topic, prepared for you, without limit. Every modern expert and six legends; a default expert of your own in the search box. 45 minutes a session. Export MP4 + share to YouTube/social. Premium voices. Priority preparation on topic misses. |
| **Feedback and surveys** | every plan | `/feedback` (ADR-0060): report an issue, suggest an improvement, request a feature, or contact us; the console's Inbox lists every message with a status. Two one-step surveys, each with a small Skip: how a new subscriber heard of us (after checkout) and why a subscriber leaves (a scheduled cancellation, or deleting the account). |
| **Professional** | $49/mo ($490/yr) | Everything in Standard, 60 minutes a session. Host rooms with up to 12 participants (11 guests, each on a paid plan of their own; a visitor or free account opening the link sees the room and is offered a plan, ADR-0058). The whole class recorded — every guest's questions included — for the host to watch or export, like a Zoom recording. Class transcripts. |
