...
| **Professional** | $49/mo ($490/yr) | Everything in Standard, 60 minutes a session. Host rooms with up to 12 participants (11 guests). The whole class recorded — every guest's questions included — for the host to watch or export, like a Zoom recording. Class transcripts. |
